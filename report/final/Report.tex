...
\chapter{Introdução}
    ...
    No segundo capítulo fundamentamos o projeto da aplicação a desenvolver
    apresentando um estudo de mercado e a viabilidade deste projeto no mundo
    real.\\
...
\chapter{Viabilidade}
    Após realizar um extensivo estudo de mercado constatamos que existiam
    algumas aplicações móveis que realizavam uma gestão rudimentar da dispensa
    em casa.\\
    No entanto faltavam várias funcionalidades para que se tornassem uma
    ferramenta para utilização diária. Como por exemplo não suportam a
    sincronização e partilha da dispensa de casa.\\
    Outrossim não existe nenhuma \textit{webapp} que proporcione um serviço
    semelhante. Também não encontramos nenhum serviço que combine a gestão de
    dispensas e a sugestão de receitas.\\
    Tendo em conta esta lacuna no mercado concluímos que o nosso projeto seria
    viável para ser desenvolvido.
    ...
    \section{Requisitos Funcionais}
        \subsection{Gestão de Utilizador}
            ...
            \begin{itemize}
                ...
                \item O utilizador deve conseguir editar o seu nome, número
            ...
            \begin{itemize}
                ...
                \item O sistema não deve permitir registo de utilizadores com
                o mesmo email.
        ...
        \subsection{Gestão de Despensas}
            ...
            \begin{itemize}
                ...
                \item O sistema deverá permitir o utilizador adicionar, editar e 
                remover as suas despensas.
                \item O sistema deverá restringir o acesso a despensas às
                quais o utilizador não tem acesso.
                \item O sistema deverá restringir a edição de nome e partilha
        ...
        \subsection{Gestão de Wishlists}
            ...
            \begin{itemize}
                ...
                \item O sistema deverá restringir o acesso aos wishlists aos
                quais o utilizador não tem acesso.
                \item O sistema deverá restringir a edição de nome e partilha
        ...
        \subsection{Gestão de lista de compras}
            ...
            \begin{itemize}
                ...
                \item O sistema deverá restringir o acesso a lista de compras
        ...
        \subsection{Adicionar utilizador a uma despensa}
            ...
            \textbf{Definição de Requisitos de Sistema}
            \begin{itemize}
                \item O sistema deverá exigir um email ao utilizador
                ...
                \item O sistema deverá restringir a edição do nome do
        ...
        \subsection{Gestão de produtos}
            ...
            \begin{itemize}
                ...
                (quando necessário).
                \item O sistema deverá restringir a adição, edição e remoção
        ...
        \subsection{Gestão de Receitas Favoritas}
            ...
            \begin{itemize}
                ...
                \item O sistema deverá restringir o acesso ao utilizador
        ...
        \subsection{Procura de Produtos}
            ...
            \begin{itemize}
                ...
                visíveis na procura de produtos.
            \end{itemize}
            \textbf{Definição de Requisitos de Sistema}
            \begin{itemize}
                \item O sistema deverá apresentar ao utilizador um ecrã
        ...
        \subsection{Procura de Receitas}
            ...
            \begin{itemize}
                ...
                visíveis na procura de receitas.
            \end{itemize}
            \textbf{Definição de Requisitos de Sistema}
            \begin{itemize}
                \item O sistema deverá apresentar ao utilizador um ecrã
        ...
        \subsection{Gestão de amizades}
            ...
            \begin{itemize}
                ...
                \item O sistema deverá restringir o acesso a lista de amigos
...
\chapter{Especificação de Use Cases}
    ...
    \section{Editar inventários}
        \begin{figure}[H]
        \centering
            \includegraphics[width=0.6\textwidth]{images/usecases/editar_iventarios_1.png}
            \includegraphics[width=0.6\textwidth]{images/usecases/editar_iventarios_2.png}
        \end{figure}

    \section{Editar wishlists}
        \begin{figure}[H]
        \centering
            \includegraphics[width=0.6\textwidth]{images/usecases/editar_whishlist_1.png}
            \includegraphics[width=0.6\textwidth]{images/usecases/editar_whishlist_2.png}
        \end{figure}

    \section{Editar listas de compras}
        \begin{figure}[H]
        \centering
            \includegraphics[width=0.6\textwidth]{images/usecases/editar_shoppinglist_1.png}
            \includegraphics[width=0.6\textwidth]{images/usecases/editar_shoppinglist_2.png}
        \end{figure}
...
\chapter{Arquitetura da Camada de Negócios}
    \section{Dicionário das Principais Classes}
        \subsection{User}
        Corresponde à representação no sistema dos utilizadores registados,
...
plataforma, sem fazer alterações ao previamente feito.

A componente do modelo foi decomposta em camada de negócio e de dados, por forma
a garantir a consistência, integridade e disponibilidade dos dados da aplicação,
...
\chapter{Produto Final}
    ...
    Nesta é possível ver todos os \textbf{inventários} que o utilizador possui
    ...
    da mesma (imagem, sumário, ingredientes e instruções), como na 
    figura abaixo.
    ...
    utilizador é a figura abaixo. Aqui será possível serem consultadas as
    receitas que o utilizador colocou como favoritas e removê-las.
...
\chapter{Conclusões}
    Concluindo, atingimos todos os objetivos propostos cumprindo todas as tarefas
